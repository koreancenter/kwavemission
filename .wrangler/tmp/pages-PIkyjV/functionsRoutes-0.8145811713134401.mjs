...
import { onRequestGet as __api_get_dashboard_stats_js_onRequestGet } from "/home/mrpark/Developer/dev/kwavemission/functions/api/get-dashboard-stats.js"
...
export const routes = [
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_get_dashboard_stats_js_onRequestGet],
    },
  {
