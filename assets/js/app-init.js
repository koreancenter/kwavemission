(function () {
    ...
    function isModalActuallyOpen() {
        var openModal = document.querySelector('.modal-root.modal-active, #news-modal:not(.hidden), #md-modal:not(.hidden)');
        if (openModal) return true;

        var drawer = document.getElementById('k-drawer') || document.getElementById('kwave-drawer');
