        ...
        <tr class="border-b border-slate-100 bg-white">
          ...
          <td class="p-3">
            <div class="flex flex-col">
              <button type="button" onclick="previewProgram(${program.id})" class="table-title-btn text-left font-medium text-slate-800 hover:font-bold leading-snug text-sm cursor-pointer p-0 bg-transparent border-0 outline-none shadow-none">${window.AdminUI.escapeHtml(program.title)}</button>
